 ...
 *               Il contient la classe PlayerPanel qui permet d'ajouter un joueur.
 *               Cette classe est similaire à RefereePanel et TeamPanel.      
 * 
...
public class PlayerPanel extends JPanel {
    ...
    private final JTextField playerSurnameField;
    private final JTextField playerAgeField; 
    private final JTextField playerPositionField;
    private final JTextField playerNumberField;
    private final JCheckBox playerStarterCheckBox;
    ...
    private void loadTeams() { // Charger les équipes dans le combobox
    ...
    private void addPlayer() { 
        ...
        String teamName = (String) teamComboBox.getSelectedItem(); // Récupérer le nom de l'équipe
    ...
    private boolean validateFields() { // Vérifier si les champs sont valides
